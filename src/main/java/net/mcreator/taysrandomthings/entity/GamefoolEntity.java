...
package net.mcreator.taysrandomthings.entity;
...
import net.mcreator.taysrandomthings.procedures.GamefoolOnInitialEntitySpawnProcedure;
import net.mcreator.taysrandomthings.procedures.GamefoolEntityDiesProcedure;
...
public class GamefoolEntity extends Monster {
	...
	public GamefoolEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TaysrandomthingsModEntities.GAMEFOOL.get(), world);
	}
	...
	public GamefoolEntity(EntityType<GamefoolEntity> type, Level world) {
		...
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(TaysrandomthingsModItems.GAMEFOOLS_AXE.get()));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(TaysrandomthingsModItems.GAMEFOOLS_AXE.get()));
	}
