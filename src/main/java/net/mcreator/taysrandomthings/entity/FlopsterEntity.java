...
public class FlopsterEntity extends Monster {
	...
	public FlopsterEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TaysrandomthingsModEntities.FLOPSTER.get(), world);
	}
	...
	public FlopsterEntity(EntityType<FlopsterEntity> type, Level world) {
		...
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(TaysrandomthingsModItems.FLOPSTERS_SCYTHE.get()));
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(TaysrandomthingsModItems.FLOPSTERS_SCYTHE.get()));
	}
