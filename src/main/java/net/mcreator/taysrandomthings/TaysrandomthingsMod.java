package net.mcreator.taysrandomthings;
...
@Mod("taysrandomthings")
public class TaysrandomthingsMod {
	public static final Logger LOGGER = LogManager.getLogger(TaysrandomthingsMod.class);
	public static final String MODID = "taysrandomthings";

	public TaysrandomthingsMod() {
		...
		TaysrandomthingsModTabs.REGISTRY.register(bus);

		TaysrandomthingsModVillagerProfessions.PROFESSIONS.register(bus);
