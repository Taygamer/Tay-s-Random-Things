...
@Mod("tays")
public class TaysMod {
	public static final Logger LOGGER = LogManager.getLogger(TaysMod.class);
	public static final String MODID = "tays";
	...
	public TaysMod() {
		...
		TaysModItems.REGISTRY.register(bus);
